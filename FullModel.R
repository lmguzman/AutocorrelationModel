...
#finally the end of the script measures divesity measures from the abundance.
...
predpreymanypred<-function(prednum=3,patch=10,N0=10, P0=5,con=c(0.4,0.4,0.4), a=c(0.3,0.3,0.3), m1=0.1,m2=c(0.1,0.1,0.1),w=c(1,2,3), K=10^10, numruns=500, gens=1000, mn=-0.1,t=10^-20,rho=0.5,std=0.7)
{
  library(abind)
